...
taylor_order = 20
total_time = 500
x0 = np.linspace(0, L, nbins) #initial x 

def main(x0_wavefunction, visualize, save):
    print(f"running particle in a box simulation with L = {L}, n = {n}, m = {m}, with starting wavefunction: {x0_wavefunction}")
